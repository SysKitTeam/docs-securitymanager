...
There are special considerations to be taken into account when working with a non global administrator account. Learn more in the [user permission requirements](basics.md#internal/requirements/user-permissions-requirements) article.
