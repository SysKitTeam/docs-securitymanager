...
If you are a Global Office 365 tenant administrator, you’ll have an option in the connection wizard to [connect to all OneDrive accounts](index.md#internal/how-to/connect-to-office-365).
